...
static int synaptics_rmi4_f54_set_sysfs(void)
{
	...
	/*remove the sysfs to synaptics_rmi4_f54_init*/
...
static int synaptics_rmi4_f54_init(struct synaptics_rmi4_data *rmi4_data)
{
	...
	/*remove the mmi_test_interfaces from synaptics_rmi4_f54_set_sysfs to here*/
...
{
	/*remove the f54 is null then return,because of if it id  faild in  "synaptics_rmi4_f54_init"
		the f54 is kfreed  the will not come in later*/
